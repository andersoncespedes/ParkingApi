...
class FuncionarioController extends Controller
{
    ...
    public function GetAllPaginate() : LengthAwarePaginator | JsonResponse{
        try{
            return $this->_unitOfWork->Funcionario()->GetAllPaginate();
    ...
    public function Save(Request $request) : JsonResponse{
        try{
            $this->_unitOfWork->Funcionario()->SaveOne($request->all());
    ...
    public function GetOne(int $id) : JsonResponse{
        try{
            $data = $this->_unitOfWork->Funcionario()->FindOne($id);
    ...
    public function RemoveOne(int $id) : JsonResponse{
        try{
            $data = $this->_unitOfWork->Funcionario()->delete($id);
    ...
    public function UpdateOne(int $id, Request $request) : JsonResponse{
        try{
            $data = $this->_unitOfWork->Funcionario()->UpdateOne($id, $request->all());
