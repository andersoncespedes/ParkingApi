...
class SolicitanteController extends Controller
{
    ...
    public function GetAllPaginate() : LengthAwarePaginator | JsonResponse{
        try{
            return $this->_unitOfWork->Solicitante()->GetAllPaginate();
    ...
    public function Save(Request $request) : JsonResponse{
        try{
            $this->_unitOfWork->Solicitante()->SaveOne($request->all());
    ...
    public function GetOne(int $id) : JsonResponse{
        try{
            $data = $this->_unitOfWork->Solicitante()->FindOne($id);
    ...
    public function RemoveOne(int $id) : JsonResponse{
        try{
            $data = $this->_unitOfWork->Solicitante()->delete($id);
    ...
    public function UpdateOne(int $id, Request $request) : JsonResponse{
        try{
            $data = $this->_unitOfWork->Solicitante()->UpdateOne($id, $request->all());
