...
class RolController extends Controller
{
    ...
    public function GetAllPaginate() : LengthAwarePaginator | JsonResponse{
        try{
            return $this->_unitOfWork->Rol()->GetAllPaginate();
    ...
    public function Save(Request $request) : JsonResponse{
        try{
            $this->_unitOfWork->Rol()->SaveOne($request->all());
    ...
    public function GetOne(int $id) : JsonResponse{
        try{
            $data = $this->_unitOfWork->Rol()->FindOne($id);
    ...
    public function RemoveOne(int $id) : JsonResponse{
        try{
            $data = $this->_unitOfWork->Rol()->delete($id);
    ...
    public function UpdateOne(int $id, Request $request) : JsonResponse{
        try{
            $data = $this->_unitOfWork->Rol()->UpdateOne($id, $request->all());
